...
#说明:支持在线和离线安装GitLab 服务器内存建议至少4G,root密码至少8位

GITLAB_VERSION=16.9.1
#GITLAB_VERSION=16.6.2
#GITLAB_VERSION=16.4.0
#GITLAB_VERSION=16.1.2
#GITLAB_VERSION=15.8.1
...
#新版密码必须符合复杂性要求且至少8位
#GITLAB_ROOT_PASSWORD=lxz@123456
#SMTP_PASSWORD=jnnxnypbyzuxbghe
...
#gitlab_rails['smtp_user_name'] = "505697096@qq.com"
#gitlab_rails['smtp_password'] = "$SMTP_PASSWORD"
#gitlab_rails['smtp_domain'] = "qq.com"
#gitlab_rails['smtp_authentication'] = "login"
#gitlab_rails['smtp_enable_starttls_auto'] = true
#gitlab_rails['smtp_tls'] = true
#gitlab_rails['gitlab_email_from'] = "505697096@qq.com"
...
#EOF
    ...
    if [ $?  -eq 0 ];then  
        ...
        GITLAB_ROOT_PASSWORD=`awk  '/^Password/{print $2}' /etc/gitlab/initial_root_password`
